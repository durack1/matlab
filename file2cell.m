...
%
%   FILE2CELL(FILENAME) returns a cell array where the i'th cell contains
%   the i'th line of the specified file.
%
%   FILE2CELL(FILENAME, OPT) might be used to remove empty cells from the
%   returned cell array.  Recognized values for OPT are
%      0 - no change
...
%   Time-stamp:  2002-03-03 13:52:18 +0100
%   E-mail:      pjacklam@online.no
%   URL:         http://home.online.no/~pjacklam
%   Extended_URL:   http://home.online.no/~pjacklam/matlab/software/util/fileutil/file2cell.m
