function  hatch_mat5(obj,angle,color,style,step,width)
...
%  11 Dec 2007 Paul Durack paul.durack@csiro.au
%  Renamed hatch_mat5 from hatch, as conflicts with existing built-in function
