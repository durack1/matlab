...
%
%   H=HERMPOLY(T,N) generates the orthonormal Hermite polynomials
...
%
%   the polynomials returned by HERMPOLY are the "physicists'" 
%   definition.
% 
%   Note that H(:,1) is the 'zeroth' order Hermite polynomial, etc.
%   H thus has N+1 columns.
%
%   Note that the zeroth-order Hermite polynomial, unity, is not
%   returned.
%
