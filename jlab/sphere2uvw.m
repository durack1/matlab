...
%
%   [U,V,W]=UVW2SPHERE(LAT,LON,V1,V2,V3) converts a vector in spherical
...
%
%   Usage: [u,v,w]=sphere2uvw(lat,lon,v1,v2,v3);
...
tol=1e-6;
reporttest('SPHERE2UVW example points',aresame(u,u2,tol)&&aresame(v,v2,tol)&&aresame(w,w2,tol))
