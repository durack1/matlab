...
%
%   See also NUM2YF, DATENUM, DATEVEC
...
reporttest('YF2NUM and NUM2YF, daily resolution, 1e-10 cutoff',bool)
...
yearf2=num2yf(num);
bool=maxmax(abs(yearf-yearf2))<1e-10;
reporttest('YF2NUM and NUM2YF, hourly resolution, 1e-10 cutoff',bool)

%yearf=[1990:(1/360/24):2004]';
%yearf=[1850:(1/360/24):2004]';
%num2yearf(yf2num(1990))
