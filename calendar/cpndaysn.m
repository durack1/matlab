...
%   $Revision: 1.15.2.4 $   $Date: 2010/10/08 16:42:32 $

% Checking input arguments and set defaults
if (nargin < 2)
   error(message('finance:cpndaysn:missingInputs'));
end

[CouponRate, Settle, Maturity, Period, Basis, EndMonthRule, IssueDate, ...
   FirstCouponDate, LastCouponDate, StartDate, Face] = instargbondmod(0 , varargin{:}); %#ok
