...
%        $Revision: 1.7.2.3 $   $Date: 2010/10/08 16:42:52 $

if nargin < 3 
  error(message('finance:lweekdate:missingInputs')) 
end 
...
if any(any(m > 12 | m < 1)) 
  error(message('finance:lweekdate:invalidMonth')) 
end 

if any(any(wkd > 7 | wkd < 1))
  error(message('finance:lweekdate:invalidWeekday'))
end 

if any(any(g > 7 | g < 0))
  error(message('finance:lweekdate:invalidWeekdayConstraint'))
end 
