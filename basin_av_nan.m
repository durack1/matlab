function [tot,pac,ind,atl,aa,apa,ain,aat] = basin_av_nan(x,y,fl)
...
% PJD 21 Apr 2009   - Updated to use NaNs as default fill, not zeros and renamed basin_av_nan.m
% PJD  8 Feb 2018   - Updated to use nx,ny as array initialization
...
[aa,apa,ain,aat] = deal(NaN(length(nx),length(ny)));
