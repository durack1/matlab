...
%   $Revision: 1.19.2.4 $  $Date: 2006/11/11 22:39:28 $
...
awtinvoke('com.mathworks.toolbox.curvefit.Fitting','createFitting');
fitting = awtinvoke('com.mathworks.toolbox.curvefit.Fitting', 'getFitting');
awtinvoke(fitting,'showFitting');
