...
%   $Revision: 1.20.2.9 $  $Date: 2006/12/15 19:26:11 $ 
...
LABELS_TO_DELETE = {'Show M-Code', 'Show Property Editor', 'Interpreter'};
tf = ismember( labels, LABELS_TO_DELETE );
delete( h(tf) );

% For the 'Delete' item, we want to redirect the call to the CFTOOL
% legend toggle function
tf = ismember( labels, 'Delete' );
